...
import indi.petshop.producer.service.ResourceService;
import indi.petshop.producer.util.MD5Util;
 ...
 * @since 2018.11.05
 */
@Controller("producerResourceController")
@RequestMapping("/producer/res")
public class ResourceController {
    ...
    @Autowired
    public void setResourceService(@Qualifier("producerResourceService") ResourceService resourceService) {
