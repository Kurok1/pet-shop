...
import indi.petshop.consumer.service.MessageService;
 ...
 * @since 2019.03.04
 */
@RestController("consumerMessageController")
...
public class MessageController {
    ...
    @Autowired
    public void setMessageService(@Qualifier("consumerMessageService") MessageService messageService) {
