...
import indi.petshop.consumer.service.ResourceService;
 ...
 * @since 2019.03.04
 */
@Controller("consumerResourceController")
@RequestMapping("/consumer/res")
public class ResourceController {
    ...
    @Autowired
    public void setResourceService(@Qualifier("consumerResourceService") ResourceService resourceService) {
