...
import indi.petshop.producer.repository.OrderRepository;
...
public class OrderService {
    ...
    @Autowired
    public void setOrderRepository(@Qualifier("producerOrderRepository") OrderRepository orderRepository) {
